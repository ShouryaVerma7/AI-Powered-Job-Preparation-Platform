...
const Home = () => {
    ...
    // Fetch reports once on mount (not inside the hook to avoid double-fetching)
    useEffect(() => {
        getReports()
    }, [])
                ...
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className={`dropzone ${fileName ? 'dropzone--filled' : ''}`} htmlFor='resume'>
                                ...
                                {fileName ? (
                                    <>
                                        <p className='dropzone__title dropzone__title--file'>{fileName}</p>
